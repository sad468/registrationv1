...
public class RegistrationController{
   ...
   public ResponseEntity<List<RegistrationDto>> getallRegistration(){
        List<RegistrationDto> dtos = registrationService.getallRegistrtion();
    ...
    @DeleteMapping
    public ResponseEntity<String>deleteRegistrtion(@RequestParam long id){
    ...
    public ResponseEntity<Registration>updateRegistration(@PathVariable long id,@RequestBody Registration registration){
        ...
        Registration update =registrationService.updateRegistration(id,registration);
